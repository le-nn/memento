...
export const LiteAsyncCounterStoreView = () => {
    // store state
    const counter = useObserver(LiteAsyncCounterStore);
    const dispatch = useDispatch(LiteAsyncCounterStore);
    // store state with sliced by selector
    const history = useObserver(LiteAsyncCounterStore, state => state.history);
    ...
    return (
        ...
        >
            ...
            >
                ...
                {
                    history.map(h =>
                        <p key={h} style={{ margin: 0, marginTop: "8px" }}>
                            history: {h}
                        </p>
                    )
                }
